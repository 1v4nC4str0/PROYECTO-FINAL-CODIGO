...
if ($token !== $expectedToken) {
    ...
    $sql = "DELETE FROM masesic_TipoGrado WHERE tipo_grado_ID = ?";
    ...
    $stmt->bind_param("i",$tipo_grado_ID);

    if ($stmt->execute()) {
       echo "El registro con ID $tipo_grado_ID ha sido eliminado correctamente.";
    } else {
