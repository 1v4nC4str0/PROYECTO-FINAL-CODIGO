...
$tipo_grado_nombre = isset($_POST["tipo_grado_nombre"]) ? $_POST["tipo_grado_nombre"] : null;

// Consulta SQL base
$sql = "SELECT tipo_grado_ID, tipo_grado_nombre FROM `masesic_TipoGrado`";
...
if (!empty($tipo_grado_nombre)) {
    $conditions[] = "tipo_grado_nombre LIKE ?";
    $params[] = "%$tipo_grado_nombre%";
}
